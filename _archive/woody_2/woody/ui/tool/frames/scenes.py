...
from ....database.tool.get_scenes_docs import get_scenes, get_scene_versions
...
class ScenesFrame:
    ...
    def on_open_scene_file(self):
        ...
        if dcc in dcc_map:
            dcc_map[dcc].open_file(root, group, element, scene, woody_id)
    ...
    def create_widgets(self):
        ...
        self.scenes_list_box.grid(row=1, column=0, columnspan=2, sticky="nsew", pady=(0,5), padx=5)
