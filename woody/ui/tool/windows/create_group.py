...
from ....directory.create_group_sequence_fd import create_group_sequence_fd
from ....database.tool.create_group_sequence_db import create_group_sequence_db
...
class CreateGroupWindow:
    ...
    def create_group(self):
        ...
        self.status_bar.set_message("Created Group!", msg_type="success")
